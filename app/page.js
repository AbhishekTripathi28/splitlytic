    ...
    <div className="flex flex-col pt-20">
      ...
      <section className="mt-20 pb-12 space-y-10 md:space-y-15 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          <Badge variant="outline" className="bg-[#3aa6a441] text-[#1F2E3D] py-1 px-3">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row justify-center">
            <Button
              asChild
              size="lg"
              className="bg-[#5b9697] hover:bg-[#0f2b36e3]"
            >
              <Link href="/dashboard">
                Get Started
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-[#5b9697] text-[#5b9697] hover:bg-[#0f2b36e3] hover:text-white"
            >
      ...
      <footer className="border-t bg-gray-50 py-12 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} Splitlytic. All rights reserved.
