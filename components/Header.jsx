...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full border-b bg-white/95 backdrop-blur z-50 supports-[backdrop-filter]:bg-white/60">
      <nav className="containe mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <Image
            src={"/logos/splitlytic_logo_crop.PNG"}
            alt="splitlytic Logo"
            width={700}
            height={100}
        ...
        <div className="flex items-center gap-4">
          <Authenticated>
            <Link href="/dashboard">
              ...
              >
                <LayoutDashboard className="h-4 w-4 text-base" />
                Dashboard
              </Button>
