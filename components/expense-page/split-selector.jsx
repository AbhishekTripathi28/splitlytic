  ...
  return (
    <div className="space-y-4 mt-4">
        ...
        >
          ...
          {type === "equal" && (
            <div className="text-right text-sm">
              {selectedCurrency}{split.amount.toFixed(2)} ({split.percentage.toFixed(1)}%)
            </div>
          )}
          ...
          {type === "percentage" && (
            <div className="flex items-center gap-4 flex-1">
              ...
              <div className="flex gap-1 items-center min-w-[100px]">
                ...
                <span className="text-sm ml-1">{selectedCurrency}{split.amount.toFixed(2)}</span>
              </div>
            </div>
          )}
      ...
      {type === "exact" && !isAmountValid && (
        <div className="text-sm text-amber-600 mt-2">
          The sum of all splits ({selectedCurrency}{totalAmount.toFixed(2)}) should equal the
          total amount ({selectedCurrency}{amount.toFixed(2)}).
        </div>
      )}
    </div>
  );
